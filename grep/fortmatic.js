window.Fortmatic = function (e) {
    ...
    function o(e) {
        var r, i;
        return e.jsonrpc = e.jsonrpc || t.JSON_RPC_VERSION, e.id = n.getPayloadId(), e.batch || "eth_batchRequest" === e.method ? (e.method = "eth_batchRequest", e.batch = null != (i = null === (r = e.batch) || void 0 === r ? void 0 : r.map((function (e) {
            return o(e)
        }))) ? i : [], e) : (e.params = e.params || [], e)
    }
    t.JSON_RPC_VERSION = "2.0", t.createJsonRpcRequestPayload = function (e, r) {
        var o = [{}];
        return r && (o = Array.isArray(r) ? r : [{
            to: r.to,
            value: r.amount
        }]), {
            params: o,
        ...
        return {
            ...
            jsonrpc: t.JSON_RPC_VERSION,
            id: n.getPayloadId(),
            batch: r.filter(Boolean).map((function (e) {
                return o(e)
            }))
        }
    ...
    var i = r(0),
        ...
        s = function (e) {
            function t(r, n) {
                var o = e.call(this, "Fortmatic SDK Error: [" + r + "] " + n) || this;
                return o.code = r, o.__proto__ = Error, Object.setPrototypeOf(o, t.prototype), o
            }
            return o(t, e), t
        }(Error);
    t.FortmaticError = s;
    ...
    var c = function (e) {
        function t(r) {
            var n, o, s = e.call(this) || this;
            s.__proto__ = Error;
            var u = Number(null === (n = r) || void 0 === n ? void 0 : n.code),
                c = (null === (o = r) || void 0 === o ? void 0 : o.message) || "Internal error";
    ...
    t.RpcError = c, t.createMissingApiKeyError = function () {
        ...
        var t, r, n, o;
        return new s(i.SDKErrorCode.InvalidArgument, "Invalid " + (t = e.argIndex, o = (r = t + 1) % 100, 1 === (n = r % 10) && 11 !== o ? r + "st" : 2 === n && 12 !== o ? r + "nd" : 3 === n && 13 !== o ? r + "rd" : r + "th") + " argument given to `" + e.functionName + "`.\n  Expected: `" + e.expected + "`\n  Received: `" + e.received + "`")
    ...
    var n = r(1);
    t.emitWeb3Payload = function (e, t, r) {
        return void 0 === r && (r = []), new Promise((function (o, i) {
            e.sendAsync(n.createJsonRpcRequestPayload(t, r), (function (e, t) {
                e ? i(e) : o(t.result)
            }))
        }))
    ...
    t.isJsonRpcBatchRequestPayload = o, t.isJsonRpcRequestPayload = i, t.isJsonRpcResponsePayload = function (e) {
        ...
        return !!e && ("string" == typeof e && Object.values(n.FmPayloadMethod).includes(e))
    }, t.isJsonRpcErrorCode = function (e) {
        return !!e && ("number" == typeof e && Object.values(n.RPCErrorCode).includes(e))
    }
}, function (e, t, r) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
    ...
    function l(e, t) {
        var r, n, o, i, a, c;
        ! function (e) {
            var t, r, n, o, i, a, s = !!e.data.response.error || !!e.data.response.message || !!e.data.response.code,
                u = {
                    message: (r = null === (t = e.data.response.error) || void 0 === t ? void 0 : t.message, n = null != r ? r : e.data.response.message, null != n ? n : "Fortmatic: Modal was closed without executing action!"),
        ...
        var l = null != (n = null === (r = t.data.response) || void 0 === r ? void 0 : r.id) ? n : void 0;
        return {
    ...
    var d = function () {
        ...
        return e.prototype.post = function (e, t, r) {
                ...
                return o(this, (function (o) {
                    switch (o.label) {
                        case 0:
                            return [4, e.iframe];
                        case 1:
                            return n = o.sent(), [2, new Promise((function (e, o) {
                                if (n.contentWindow) {
                                    var d = [],
                                        p = s.isJsonRpcBatchRequestPayload(r) ? r.batch.map((function (e) {
                                            return e.id
                                        })) : [];
                                    ...
                                    var f = i.on(a.FmIncomingWindowMessage.FORTMATIC_HANDLE_RESPONSE, (h = function () {
                                            ...
                                            var n = l(r, t),
                                                o = n.id,
                                                i = n.response;
                                            o && s.isJsonRpcBatchRequestPayload(r) && p.includes(o) ? (d.push(i.payload), d.length === r.batch.length && (h(), e(d))) : o && o === r.id && (h(), e(i.payload))
                                        })),
                                        y = i.on(a.FmIncomingWindowMessage.FORTMATIC_USER_DENIED, function (t) {
                                            return function (n) {
                                                ...
                                                if (i && s.isJsonRpcBatchRequestPayload(r) && p.includes(i)) {
                                                    d.push(f);
                                                    for (var y = d.length; y < r.batch.length; y++) d.push(new u.JsonRpcResponse(r.batch[y]).applyError(c).payload);
                                                    t(), e(d)
                                                } else i && i === r.id && (t(), e(f))
                                            }
                                        }((function () {
            ...
            var r = this,
                n = t.bind(window),
                o = function (t) {
                    t.data.msgType === e + "-" + r.encodedQueryParams && n(t)
                };
    ...
    var n = r(4),
        o = function () {
            function e(t) {
                t instanceof e ? (this._jsonrpc = t.payload.jsonrpc, this._id = t.payload.id, this._result = t.payload.result, this._error = t.payload.error) : n.isJsonRpcResponsePayload(t) ? (this._jsonrpc = t.jsonrpc, this._id = t.id, this._result = t.result, this._error = t.error) : (this._jsonrpc = t.jsonrpc, this._id = t.id, this._result = null, this._error = null)
            }
    ...
    var s = o(r(0));
    Object.assign(i.Fortmatic, n(n({}, s), {
    ...
    var s = r(11),
        ...
        v = function () {
            function e(e) {
                ...
                this.apiKey = e.apiKey, this.endpoint = new URL(e.endpoint).origin, this.encodedQueryParams = h.encodeQueryParameters({
                    API_KEY: this.apiKey,
    ...
    var g = function (e) {
        function t(t, r) {
            ...
            return n.user = new u.PhantomUser(n), n
        }
        return o(t, e), t.prototype.loginWithMagicLink = function (e) {
            return i(this, void 0, void 0, (function () {
                ...
                return a(this, (function (i) {
                    switch (i.label) {
                        case 0:
                            return t = e.email, r = e.showUI, n = void 0 === r || r, o = f.createJsonRpcRequestPayload(d.FmPayloadMethod.fm_auth_login_with_magic_link, [{
                                email: t,
                                showUI: n
    ...
    var b = function (e) {
        function t(t, r) {
            ...
            return n.transactions = new c.TransactionsModule(n), n.user = new l.UserModule(n), n
        }
    ...
    var i = r(0),
        ...
        s = function (e) {
            ...
            return o(t, e), t.prototype.send = function (e, t) {
                var r = a.createJsonRpcRequestPayload(i.FmPayloadMethod.fm_composeSend, e);
                this.sdk.getProvider().sendFortmaticAsync(r, t)
            }, t
        }(r(5).BaseModule);
    ...
    var s = r(0),
        ...
        l = function (e) {
            ...
            return o(t, e), t.prototype.login = function () {
                ...
                return u.emitFortmaticPayload(this.sdk.getProvider(), e)
            }, t.prototype.deposit = function () {
                var e = c.createJsonRpcRequestPayload(s.FmPayloadMethod.fm_deposit);
                return u.emitFortmaticPayload(this.sdk.getProvider(), e)
            }, t
        }(r(5).BaseModule);
    t.UserModule = l
    ...
    var i = r(0),
        ...
        f = function () {
            function e(e, t, r) {
                this.apiKey = t, this.isFortmatic = !0, this.queue = [], this.overlay = new c.FmIframeController(e, r), this.payloadTransport = new l.FmPayloadTransport(e, r), this.listen()
            }
            return e.prototype.sendAsync = function (e, t) {
                ...
                var r = s.standardizeRequestPayload(e);
                return u.isJsonRpcBatchRequestPayload(r), this.enqueue({
                    onRequestComplete: t,
                    payload: r
                })
                ...
                return n(this, void 0, void 0, (function () {
                    ...
                    return o(this, (function (o) {
                        switch (o.label) {
                            ...
                            case 1:
                                r = o.sent(), e.onRequestComplete(null, r), o.label = 2;
                            case 2:
                            ...
                            case 3:
                                (n = o.sent()).error ? e.onRequestComplete(new p.RpcError(n.error), n) : e.onRequestComplete(null, n), o.label = 4;
                            case 4:
                ...
                this.payloadTransport.on(i.FmIncomingWindowMessage.FORTMATIC_OVERLAY_READY, (function () {
                    ...
                    e.queue.forEach((function (e) {
                        ...
                        e.onRequestComplete(new p.RpcError(r), t.applyError(r).payload)
                    })), e.queue.slice(0)
                }))
            }, e
        }();
            ...
            return new Promise((function (t) {
                var r = function () {
                    if (o = e.encodedQueryParams, s = [].slice.call(document.querySelectorAll(".fortmatic-iframe")), Boolean(s.find((function (e) {
                        ...
                        r.classList.add("fortmatic-iframe"), r.dataset.fortmaticIframeLabel = new URL(e.endpoint).host, r.src = new URL("/send?params=" + e.encodedQueryParams, e.endpoint).href,
                            function (e) {
                                var t, r;
                                try {
                                    for (var n = i(Object.entries(l)), o = n.next(); !o.done; o = n.next()) {
                                        var s = a(o.value, 2),
                                            u = s[0],
                                            c = s[1];
                                        e.style[u] = c
                        ...
                        n.src = "https://static.fortmatic.com/assets/trans.gif", n.style.position = "fixed", document.body.appendChild(n), t(r)
                    }
                    var o, s
                };
                ["loaded", "interactive", "complete"].includes(document.readyState) ? r() : window.addEventListener("load", r, !1)
            }))
